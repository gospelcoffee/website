...
- Closed after today's hours (i.e., we already closed today): `Closed now · Opens tomorrow at 7 AM` — or use the next-open day's full weekday name when it's more than one day away: `Closed now · Opens Wednesday at 7 AM`
- Closed for the entire day (no hours today): `Closed today · Opens Wednesday at 7 AM` — drop the trailing `· Opens …` clause if there's no upcoming open day in the next week.
