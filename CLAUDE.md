...
- The page is composed of three separately-headed paper-style cards: **Menu** (the main menu), **Not coffee**, and **Tasting experience**. Each card has its own small-caps eyebrow header above it (`<h1 class="eyebrow">Menu</h1>`, `<h2 class="eyebrow">Not coffee</h2>`, `<h2 class="eyebrow">Tasting experience</h2>`) so the cards read as siblings, not nested sections.
